...
import com.emps.abroadjobs.data.model.AppVersionResponse;
import com.emps.abroadjobs.data.model.AppVersionData;
import com.emps.abroadjobs.data.api.VersionCheckRequest;
import com.emps.abroadjobs.network.RecruiterApiService;
        ...
        call.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    String errorMessage = "Profile request failed: " + response.message();
            ...
            public void onFailure(Call<User> call, Throwable t) {
                Log.e("ApiClient", "Profile network error", t);
                callback.onError("Network error: " + t.getMessage());
            }
        });
    }
            ...
            public void onResponse(okhttp3.Call call, okhttp3.Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        ApiResponse<Map<String, Object>> apiResponse = SafeJsonParser.parseMapResponse(responseBody);

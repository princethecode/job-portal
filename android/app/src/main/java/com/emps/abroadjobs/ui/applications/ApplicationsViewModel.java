package com.emps.abroadjobs.ui.applications;
...
public class ApplicationsViewModel extends AndroidViewModel {
    ...
    private final MutableLiveData<List<com.emps.abroadjobs.models.Application>> applications = new MutableLiveData<>();
    ...
    public LiveData<List<com.emps.abroadjobs.models.Application>> getApplications() {
        return applications;
    }
                ...
                try {
                    if (response.isSuccess() && response.getData() != null) {
                        ...
                        if (data.containsKey("jobs")) {
                            ...
                            List<com.emps.abroadjobs.models.Application> applicationList = new ArrayList<>();
    ...
    private void processJobsList(List<?> jobs, List<com.emps.abroadjobs.models.Application> applicationList) {
        for (Object jobObj : jobs) {
            ...
            if (jobMap.containsKey("application")) {
                try {
                    ...
                    com.emps.abroadjobs.models.Application application = 
                        new com.emps.abroadjobs.models.Application();
    ...
    private void processJobsMap(Map<?, ?> jobsMap, List<com.emps.abroadjobs.models.Application> applicationList) {

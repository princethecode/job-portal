...
public final class FragmentNotificationsBinding implements ViewBinding {
  ...
  private FragmentNotificationsBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView emptyView, @NonNull RecyclerView notificationsRecyclerView,
      @NonNull SwipeRefreshLayout swipeRefreshLayout, @NonNull TextView textNotifications) {
  ...
  public static FragmentNotificationsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentNotificationsBinding((ConstraintLayout) rootView, emptyView,
          notificationsRecyclerView, swipeRefreshLayout, textNotifications);
    }

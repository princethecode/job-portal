...
public final class FragmentJobsBinding implements ViewBinding {
  ...
  private FragmentJobsBinding(@NonNull ConstraintLayout rootView, @NonNull TextView emptyView,
      @NonNull RecyclerView jobsRecyclerView, @NonNull ProgressBar progressBar,
      @NonNull TextView textJobs) {
    this.rootView = rootView;
    this.emptyView = emptyView;
    this.jobsRecyclerView = jobsRecyclerView;
    this.progressBar = progressBar;
    this.textJobs = textJobs;
  }
  ...
  public static FragmentJobsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.jobs_recycler_view;
      RecyclerView jobsRecyclerView = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.text_jobs;
      TextView textJobs = ViewBindings.findChildViewById(rootView, id);
      if (textJobs == null) {
        break missingId;
      }

      return new FragmentJobsBinding((ConstraintLayout) rootView, emptyView, jobsRecyclerView,
          progressBar, textJobs);
    }
